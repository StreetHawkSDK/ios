...
extern NSString * const SHKeyChainStoreErrorDomain;

typedef NS_ENUM(NSInteger, SHKeyChainStoreErrorCode) {
    SHKeyChainStoreErrorInvalidArguments = 1,
};

typedef NS_ENUM(NSInteger, SHKeyChainStoreItemClass) {
    SHKeyChainStoreItemClassGenericPassword = 1,
    SHKeyChainStoreItemClassInternetPassword,
};

typedef NS_ENUM(NSInteger, SHKeyChainStoreProtocolType) {
    SHKeyChainStoreProtocolTypeFTP = 1,
    SHKeyChainStoreProtocolTypeFTPAccount,
    SHKeyChainStoreProtocolTypeHTTP,
    SHKeyChainStoreProtocolTypeIRC,
    SHKeyChainStoreProtocolTypeNNTP,
    SHKeyChainStoreProtocolTypePOP3,
    SHKeyChainStoreProtocolTypeSMTP,
    SHKeyChainStoreProtocolTypeSOCKS,
    SHKeyChainStoreProtocolTypeIMAP,
    SHKeyChainStoreProtocolTypeLDAP,
    SHKeyChainStoreProtocolTypeAppleTalk,
    SHKeyChainStoreProtocolTypeAFP,
    SHKeyChainStoreProtocolTypeTelnet,
    SHKeyChainStoreProtocolTypeSSH,
    SHKeyChainStoreProtocolTypeFTPS,
    SHKeyChainStoreProtocolTypeHTTPS,
    SHKeyChainStoreProtocolTypeHTTPProxy,
    SHKeyChainStoreProtocolTypeHTTPSProxy,
    SHKeyChainStoreProtocolTypeFTPProxy,
    SHKeyChainStoreProtocolTypeSMB,
    SHKeyChainStoreProtocolTypeRTSP,
    SHKeyChainStoreProtocolTypeRTSPProxy,
    SHKeyChainStoreProtocolTypeDAAP,
    SHKeyChainStoreProtocolTypeEPPC,
    SHKeyChainStoreProtocolTypeNNTPS,
    SHKeyChainStoreProtocolTypeLDAPS,
    SHKeyChainStoreProtocolTypeTelnetS,
    SHKeyChainStoreProtocolTypeIRCS,
    SHKeyChainStoreProtocolTypePOP3S,
};

typedef NS_ENUM(NSInteger, SHKeyChainStoreAuthenticationType) {
    SHKeyChainStoreAuthenticationTypeNTLM = 1,
    SHKeyChainStoreAuthenticationTypeMSN,
    SHKeyChainStoreAuthenticationTypeDPA,
    SHKeyChainStoreAuthenticationTypeRPA,
    SHKeyChainStoreAuthenticationTypeHTTPBasic,
    SHKeyChainStoreAuthenticationTypeHTTPDigest,
    SHKeyChainStoreAuthenticationTypeHTMLForm,
    SHKeyChainStoreAuthenticationTypeDefault,
};

typedef NS_ENUM(NSInteger, SHKeyChainStoreAccessibility) {
    SHKeyChainStoreAccessibilityWhenUnlocked = 1,
    SHKeyChainStoreAccessibilityAfterFirstUnlock,
    SHKeyChainStoreAccessibilityAlways,
    SHKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly
    __OSX_AVAILABLE_STARTING(__MAC_10_10, __IPHONE_8_0),
    SHKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly,
    SHKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly,
    SHKeyChainStoreAccessibilityAlwaysThisDeviceOnly,
}
__OSX_AVAILABLE_STARTING(__MAC_10_9, __IPHONE_4_0);

typedef NS_ENUM(unsigned long, SHKeyChainStoreAuthenticationPolicy) {
    SHKeyChainStoreAuthenticationPolicyUserPresence        = 1 << 0,
    SHKeyChainStoreAuthenticationPolicyTouchIDAny          NS_ENUM_AVAILABLE(10_12_1, 9_0) = 1u << 1,
    SHKeyChainStoreAuthenticationPolicyTouchIDCurrentSet   NS_ENUM_AVAILABLE(10_12_1, 9_0) = 1u << 3,
    SHKeyChainStoreAuthenticationPolicyDevicePasscode      NS_ENUM_AVAILABLE(10_11, 9_0) = 1u << 4,
    SHKeyChainStoreAuthenticationPolicyControlOr           NS_ENUM_AVAILABLE(10_12_1, 9_0) = 1u << 14,
    SHKeyChainStoreAuthenticationPolicyControlAnd          NS_ENUM_AVAILABLE(10_12_1, 9_0) = 1u << 15,
    SHKeyChainStoreAuthenticationPolicyPrivateKeyUsage     NS_ENUM_AVAILABLE(10_12_1, 9_0) = 1u << 30,
    SHKeyChainStoreAuthenticationPolicyApplicationPassword NS_ENUM_AVAILABLE(10_12_1, 9_0) = 1u << 31,
}__OSX_AVAILABLE_STARTING(__MAC_10_10, __IPHONE_8_0);

@interface SHKeyChainStore : NSObject

@property (nonatomic, readonly) SHKeyChainStoreItemClass itemClass;

@property (nonatomic, readonly, nullable) NSString *service;
@property (nonatomic, readonly, nullable) NSString *accessGroup;

@property (nonatomic, readonly, nullable) NSURL *server;
@property (nonatomic, readonly) SHKeyChainStoreProtocolType protocolType;
@property (nonatomic, readonly) SHKeyChainStoreAuthenticationType authenticationType;

@property (nonatomic) SHKeyChainStoreAccessibility accessibility;
@property (nonatomic, readonly) SHKeyChainStoreAuthenticationPolicy authenticationPolicy
__OSX_AVAILABLE_STARTING(__MAC_10_10, __IPHONE_8_0);
...
+ (SHKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service;
+ (SHKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service accessGroup:(nullable NSString *)accessGroup;
...
+ (nullable NSArray UIC_KEY_TYPE *)allKeysWithItemClass:(SHKeyChainStoreItemClass)itemClass;
- (nullable NSArray UIC_KEY_TYPE *)allKeys;

+ (nullable NSArray *)allItemsWithItemClass:(SHKeyChainStoreItemClass)itemClass;
...
@interface SHKeyChainStore (ErrorHandling)
...
@interface SHKeyChainStore (ForwardCompatibility)
...
@interface SHKeyChainStore (Deprecation)
