...
+ (void)aspect
{
    ...
    [UICollectionViewController aspect_hookSelector:@selector(viewWillAppear:)
                                   withOptions:AspectPositionAfter
                                    usingBlock:^(id<AspectInfo> aspectInfo, BOOL animated) {
                                        UICollectionViewController *vc = (UICollectionViewController *)aspectInfo.instance;
                                        if (!shIsSDKViewController(vc))
    ...
    [UICollectionViewController aspect_hookSelector:@selector(viewDidAppear:)
                                   withOptions:AspectPositionAfter
                                    usingBlock:^(id<AspectInfo> aspectInfo, BOOL animated) {
                                        UICollectionViewController *vc = (UICollectionViewController *)aspectInfo.instance;
                                        if (!shIsSDKViewController(vc))
    ...
    [UICollectionViewController aspect_hookSelector:@selector(viewWillDisappear:)
                                   withOptions:AspectPositionAfter
                                    usingBlock:^(id<AspectInfo> aspectInfo, BOOL animated) {
                                        UICollectionViewController *vc = (UICollectionViewController *)aspectInfo.instance;
                                        if (!shIsSDKViewController(vc))
