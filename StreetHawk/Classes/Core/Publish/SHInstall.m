...
- (NSDictionary *)saveBody
{
    ...
    NSString *revokeDate = (disablePushTimeVal == nil || [disablePushTimeVal doubleValue] == 0) ? @"" : shFormatISODate([NSDate dateWithTimeIntervalSince1970:disablePushTimeVal.doubleValue]);
