...
# export ipa
xcodebuild -exportArchive -archivePath ../build/outputs/SHStatic.xcarchive -exportPath ../build/outputs/ -exportOptionsPlist ExportOptions.plist
...
# export ipa
xcodebuild -exportArchive -archivePath ../build/outputs/SHDynamic.xcarchive -exportPath ../build/outputs/ -exportOptionsPlist ExportOptions.plist
